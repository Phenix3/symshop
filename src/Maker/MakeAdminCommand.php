...
class MakeAdminCommand extends AbstractMakeCommand
{
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        $entity = $this->askClass('Pour quelle entité', 'Entity/*', $io);
        ...
        $this->createFile('admin/controller', $params, "src/Admin/Controller/{$entityName}Controller.php");
        $this->createFile('admin/CrudData.php', $params, "src/Admin/DataClass/{$entityName}CrudData.php");
